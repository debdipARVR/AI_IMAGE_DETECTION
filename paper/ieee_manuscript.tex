...
Table~\ref{tab:clean_benchmark} presents the quantitative metrics across the 30 clean native resolution evaluation samples.

\begin{table}[h]
\caption{Quantitative Reconstruction & Spectral Metrics on Clean Benchmark ($N=30$)}
...
\midrule
Reconstruction PSNR & $33.11 \pm 0.14\text{ dB}$ & $36.94 \pm 0.07\text{ dB}$ & $\mathbf{+3.83\text{ dB}}$ \\
Reconstruction MSE & $0.001955 \pm 0.000062$ & $0.000809 \pm 0.000013$ & $\mathbf{-58.6\%}$ \\
Harmonic Spike Ratio & $1.141\times$ & $2.268\times$ & $\mathbf{+1.127\times}$ \\
\midrule
\textbf{Clean AUROC} & \multicolumn{3}{c}{\textbf{100.00\%} (Zero False Accusations)} \\
\bottomrule
\end{tabular}
\end{table}
